...
The cost of coordinating agents is not trivial. See [the foreman problem](@/pages/harness-engineering/the-foreman-problem.md) for what happened when this scaled to 22 agents (peak 7 simultaneous) across 50 hours.
