...
og_image = "/images/pages/harness-engineering/meta-skills.png"
+++

![A skill that creates skills](/images/pages/harness-engineering/meta-skills.png)

*[Deadpool](https://en.wikipedia.org/wiki/Deadpool) is the comic book character famous for breaking the fourth wall: he knows he's in a comic and talks directly to the reader. A meta-skill does the same thing to the harness: it's a component that knows it's a component, and its job is to create and modify other components. Not just skills, but agents, extensions, tools, commands, workflows, and configs. The harness modifying itself.*
